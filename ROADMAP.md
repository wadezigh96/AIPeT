...
A decentralized robot-pet agent that helps users with everyday needs, monetized via **x402 micropayments**, authenticated with **Privy**, and available as a **Farcaster Mini App** — with first-class support for **Solana**, Base, and BNB Chain.
...
## Phase 2 — Solana-native payments

**Goal:** real Solana x402 path (critical for Solana / Colosseum tracks).
...
- [ ] Optional: store tip/donate receipts on-chain (memo or lightweight program)

**Owners:** backend + Solana engineer
...
- [ ] Creator dashboard (revenue by chain)
